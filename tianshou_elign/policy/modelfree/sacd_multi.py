...
class SACDMultiPolicy(BasePolicy):
    ...
    :param list[str] actor: list of actor_ids for each agent
    ...
    def __init__(self,
        ...
        assert len(agent_ids) == len(actors) == len(critic1s) == len(critic2s), \
            'number of agent_ids, actors, critics should be the same'
    ...
    def forward(self, batch: Batch,
        ...
        for i, actor in enumerate(self.actors):
            ...
            logit, h = actor(obs.get(agent_id))            
